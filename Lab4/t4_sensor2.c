...
static bool en_print = 0;    //like output_enabled
static bool continuous = 0;     //like output_continuous
...
static esos_sensor_process_t u8_read_type = ESOS_SENSOR_ONE_SHOT; //store the e_senProcess here 
    ...
    ESOS_TASK_BEGIN();
        while(TRUE){
            ...
            if (my_state == 0){
                ...
                // else if (esos_uiF14_isSW1Pressed() || esos_uiF14_isSW1Pressed()){
                //     ESOS_TASK_WAIT_TICKS( 25 ); //debounce
                //     my_state = 0;
                // }
            } 
                ...
                else if (u8_process != '1' && my_state == 5){
                        // print process menu
                        ESOS_TASK_WAIT_ON_AVAILABLE_OUT_COMM();
